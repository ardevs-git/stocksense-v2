...
export const ProductIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z" /><line x1="3" x2="21" y1="6" y2="6" /><path d="M16 10a4 4 0 0 1-8 0" /></svg>
);

export const InventoryIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4 18h16"/><path d="M4 14h16"/><path d="M4 10h16"/><path d="M4 6h16"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-2"/><path d="M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h2"/></svg>
);

export const ReportIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M17.5 19H9a7 7 0 1 1 6.326-11.82A4.5 4.5 0 1 1 22 17.5"/><path d="M16 14v4M16 8v2"/><path d="M12 14v4M12 6v4"/><path d="M8 14v4M8 8v2"/><path d="M4 14v4M4 10v0"/></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M12 3a6.6 6.6 0 0 0-4.07 1.5" />
      <path d="M16.07 4.5A6.6 6.6 0 0 1 21 9" />
      <path d="M3 9a6.6 6.6 0 0 1 4.93-4.5" />
      <path d="M7.93 19.5a6.6 6.6 0 0 0 8.14 0" />
      <path d="M12 21a6.6 6.6 0 0 0 4.07-1.5" />
      <path d="M16.07 19.5A6.6 6.6 0 0 1 21 15" />
      <path d="M3 15a6.6 6.6 0 0 1 4.93 4.5" />
      <path d="M7.93 4.5A6.6 6.6 0 0 0 3 9" />
    </svg>
);
...
// FIX: Added missing SearchIcon export to fix import error in components/PurchaseEntry.tsx
